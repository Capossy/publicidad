                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="file/create" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Subir Video</a>
                            <a href="file" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Ver galeria</a>
                        </div>
                    </div>
                </div>
